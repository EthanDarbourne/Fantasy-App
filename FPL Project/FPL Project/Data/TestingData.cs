...
#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
		public TestingData(PlayerDetails playerDetails)
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
		{
			LoadPlayerDetails( playerDetails );
		}

		public TestingData(TrainingData data)
		{
			Id = data.Id;
			Name = data.Name;
			Team = data.Team;
		...
		public override string Stringify()
		{
			...
			str.Append( $",{Opponent}," );
			str.AppendJoin( ',', new double[] { OppenentGoalsScored, OpponentGoalsConceded, OpponentGoalsScoredInLastFive, OpponentGoalsConcededInLastFive } );
